...
class Wiki_Crawler:
        ...
        if os.path.exists(progress_file):
            try:
                with open(progress_file, 'r') as f:
                    ...
                    logger.info(f"Loaded progress: {self.pages_processed} pages previously crawled")
    ...
    def store_page(self, data):
        ...
        try:
            ...
            logger.info(f"Stored page {self.pages_processed}/{self.max_pages}: {data['title']}")
        except Exception as e:
    ...
    def crawl(self):
        ...
        try:
            while self.url_queue and self.pages_processed < self.max_pages:
                ...
                logger.info(f"Processing {current_url} ({self.pages_processed + 1}/{self.max_pages})")
